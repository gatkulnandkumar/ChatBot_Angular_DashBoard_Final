...
export class UpdateTemplateComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service.getById(globalUrl.gateWayUrl,this.router.snapshot.params.id).subscribe((result) => {
  ...
  onSubmit(form: any): void {
    ...
    this.service.updateTemplateData(globalUrl.gateWayUrl,formData).subscribe(
      (result) => {
    ...
    if(formData.id != null){
      ...
      this.toastr.error('Invalid ID to update', '', {
        timeOut: 2000,
      });
    }
